  ...
  <div class="photos-container">
    <details class="explainer">
      ...
      channel on discord or through the Meetup page.</li>
        ...
        <li>If you want a photo of you removed from the page, or if yo have any other issues with a photo on this page, please let us know through → <a href="https://github.com/owddm/public/issues/new">a new github issue</a>.</li>
