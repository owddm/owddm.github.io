...
import SocialMedia from "./header/SocialMedia.vue";
  ...
  <header :class="{ 'site-header': true, open: page_state.isHamburgerMenuOpen, closed: !page_state.isHamburgerMenuOpen }">
    <div class="header--container">
      ...
      <nav role="navigation" class="header--links">
        <ul class="list-reset">
          <li>
            <AstroLink activeClass="active-menu" href="/">Home</AstroLink>
          </li>
          <li>
            <AstroLink activeClass="active-menu" href="/about">About</AstroLink>
          </li>
          <li>
            <AstroLink activeClass="active-menu" href="/events">Events</AstroLink>
          </li>
          <li>
            <AstroLink activeClass="active-menu" href="/photos">Photos</AstroLink>
          </li>
        </ul>
      </nav>
      <div class="header--join-link">
        <AstroLink class="join-link" href="/join">→ Join</AstroLink>
      </div>
