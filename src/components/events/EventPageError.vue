...
withDefaults(defineProps<Props>(), {
  ...
  message: "Event is either not loading or the event ID is incorrect. Please check the event ID and try again.",
});
</script>
...
<template>
  <div class="container">
    ...
    <br />
    <div>
      <AstroLink href="/events"><button>Return to the Events Page</button></AstroLink>
    </div>
  </div>
</template>
