  ...
  <section class="about">
    ...
    <div class="about-content">
      ...
      <div class="about-description-container">
        ...
        <p>
          <em>Alright,</em> the OWDDM is a volunteer, non-profit group that organizes meetups in Kansai. We usually have one meetup per month and region. Usually, during the meetups, one or two community members present about a topic of their choosing. Occasionally, we hold other
          events such as Hanami’s, hikes, and other get-togethers.
        </p>
        <p>
      ...
      <div class="about-single-container">
        ...
        <p>
          ...
          <a href="https://leichtgewicht.at">Martin Heidegger</a>. He carries the final responsibility for all issues and has final say, but he does not work by himself. Volunteers can, and have been, taking care of accounting; organizing meetups; work on the homepage; moderating
          the Discord and other things such as sending out announcements of events. The current volunteers can be recognized by their <em>"Volunteer"</em> role in the <a href="/discord">Discord chat</a>.
        </p>
        <p>
