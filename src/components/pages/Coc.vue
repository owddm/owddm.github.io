  ...
  <section class="coc">
    <div class="coc-content">
      ...
      <div class="coc-description-container">
        ...
        <p>
          This code of conduct applies to all spaces (real or digital) managed by the OWDDM・KWDDM group. This includes but is not limited to the our physical events, Discord Chat, Github, LinkedIn, and any other system created or maintained by the group. In addition, violations
          of this code outside these spaces may affect a person's ability to participate within them.
        </p>
        <p>If you believe someone is violating the code of conduct, we ask that you report it to <a href="mailto:owddm@proton.me">owddm@proton.me</a> and follow the <a href="/coc-report">Reporting Guide</a>.</p>
        <ul>
          <li>
          ...
          <li>
            <h4>Be welcoming.</h4>
            <p>
              We strive to be a community that welcomes and supports people of all backgrounds and identities. This includes, but is not limited to members of any race, ethnicity, culture, national origin, colour, immigration status, social and economic class, educational level,
          ...
          <li>
            ...
            <p>
              Your work will be used by other people, and you in turn will depend on the work of others. Any decision you take will affect users and colleagues, and you should take those consequences into account when making decisions. Remember that we're a world-wide community,
          ...
          <li>
            ...
            <p>
              Disagreements, both social and technical, happen all the time and the OWDDM・KWDDM community is no exception. It is important that we resolve disagreements and differing views constructively. Remember that we’re different. The strength of the OWDDM・KWDDM community
              comes from its varied community, people from a wide range of backgrounds. Different people have different perspectives on issues. Being unable to understand why someone holds a viewpoint doesn’t mean that they’re wrong. Don’t forget that it is human to err and
              blaming each other doesn’t get us anywhere. Instead, focus on helping to resolve issues and learning from mistakes.
            </p>
          </li>
        </ul>
        <p>Adapted from the <a href="https://web.archive.org/web/20141109123859/http://speakup.io/coc.html">Speak Up! project</a>.</p>
      </div>
    </div>
  </section>
</template>
