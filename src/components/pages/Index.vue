...
import { type EventData, transform, getLatestEvents } from "../../utils/events.ts";
import { formatDate } from "../../utils/utils.ts";
import type { WatchStopHandle } from "vue";

const { ref, onMounted, watchEffect, provide } = vue;
...
const markers = getLatestEvents(transform(data))
